                                    ...
                                    @foreach ($this->Sections as $single_section)
                                        <tr class="hover:bg-gray-100">
                                            <td
                                                ...
                                                {{ $single_section->name }}</td>

                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                                                {{ $single_section->level->name }}</td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                                                {{ $single_section->created_at->diffForHumans() }}</td>


                                            <td class="px-6 py-4  whitespace-nowrap text-end text-sm font-medium">
                                                <a wire:navigate
                                                    href="{{ URL('/section/' . $single_section->slug . '/edit') }}"
                                                    type="button"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <button wire:click="delete('{{ $single_section->slug }}')"
                                                    type="button"
