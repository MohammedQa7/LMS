<x-app-layout>
    ...
    <div class="creation-header flex items-center mb-4">
        <a class="me-3 border p-3 shadow-sm rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-700 transition-all" href="{{ URL('/section') }}">
        ...
        <h2 class="text-4xl font-extrabold dark:text-white ">New Section</h2>
    </div>
    ...
    <div
        ...
        <form action="#">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="last-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Level
                    </label>
