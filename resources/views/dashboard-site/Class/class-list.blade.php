        ...
        <div class="flex items-center justify-center ">
            <div
                ...
                <nav class="flex gap-x-1 w-full" aria-label="Tabs" role="tablist">
                    <button type="button"
                        class="bg-white  text-gray-700 hover:indigo-200 dark:bg-neutral-800 dark:text-neutral-400 py-3 px-4 inline-flex items-center gap-x-2  text-sm text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 font-medium rounded-lg  disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-white dark:focus:text-white active"
                        id="segment-item-1" role="tab">
                        High school akjsdnaksjd
                    </button>

                    <button type="button"
                        class="  text-gray-700  hover:bg-white dark:bg-neutral-800 dark:text-neutral-400 py-3 px-4 inline-flex items-center gap-x-2  text-sm text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 font-medium rounded-lg  disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-white dark:focus:text-white active"
                        role="tab">
                        High school akjsdnaksjd
                    </button>
