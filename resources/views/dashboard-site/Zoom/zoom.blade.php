<x-app-layout>
    <div class="creation-header flex items-center mb-4">
        <svg class="w-12 h-12 me-2" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h2 class="text-4xl font-extrabold dark:text-white ">{{ trans('generalTrans.PageTitle.zoom-meetings') }}</h2>
    </div>

    @livewire('zoom.ZoomListComponent' , ['meetings' => $meetings])
