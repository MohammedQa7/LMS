<div>
    <div x-show="modelInnerOpen" x-on:close-inner-modal.window = "modelInnerOpen = false"
        class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            <div x-cloak @click="modelInnerOpen = false" x-show="modelInnerOpen"
            ...
            <div x-cloak x-show="true" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="flex items-center justify-between space-x-4">
                    ...
                    <button @click="modelInnerOpen = false"
                ...
                <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5 mt-4">
                    <div class="title_fields">
                        ...
                        <input wire:model="lecture_section_name_ar"
                    ...
                    <div class="title_fields">
                        ...
                        <input wire:model="lecture_section_name_en"
                            placeholder="{{ trans('subject-content-modal.lecture_title_placeholder') }}" type="text"
                            class="block w-full px-3 py-2 mt-2 mb-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                        @error('lecture_section_name_en')
                            <x-dashboard.validation-error-message :message="$message"></x-dashboard.validation-error-message>
                        @enderror
                    </div>
                </div>
                <div class="flex justify-end mt-6">
                    ...
                    <button wire:click.prevent="createLectureSection"
                        ...
                        Add
                        <x-loading-indecator :loading_action="'createLectureSection'"></x-loading-indecator>
                    </button>
                </div>
            </div>
        </div>
