...
<div>
    @if ($current_level)
        <div x-show="modelOpen" x-on:close-custom-modal.window = "modelOpen = false"
            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                <div x-cloak x-show="true" x-transition:enter="transition ease-out duration-300 transform"
                    ...
                    class="inline-block w-full max-w-2xl p-8 my-20 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl 2xl:max-w-2xl">
                    ...
                    {{-- Livewire FORM --}}
                    @livewire('materials.MaterialFormComponent', ['current_level' => $current_level],key('material-form-' . $current_level->id))
